...
const SearchResultsScreen = ({ route, navigation }) => {
  ...
  const ownerIdFilter = route.params?.ownerId || null;
  const filterByOwnerOnly = route.params?.filterByOwnerOnly || false;
  ...
  const searchRooms = async () => {
    ...
    try {
      const params = {
        ...
        limit: 50,
        ownerId: filterByOwnerOnly ? ownerIdFilter : undefined,
      };
