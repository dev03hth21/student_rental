...
// MapTiler API Key
// Get your free key at: https://www.maptiler.com/cloud/
// Or use env variable if configured
const MAPTILER_KEY = process.env.MAPTILER_API_KEY || 'quVrJDcYbgVNrDgIF5R5';
